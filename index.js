...
var ASM_CONSTS = {
  174848: () => { FS.syncfs(function(err) { if (err) console.error(err); }); },  
 174907: () => { if (!FS.analyzePath('/data').exists) { FS.mkdir('/data'); } FS.mount(IDBFS, {}, '/data'); FS.syncfs(true, function(err) { _on_fs_loaded(); }); },  
 175054: () => { if (document.fullscreenElement) return 1; },  
 175100: () => { return Module.canvas.width; },  
 175132: () => { return parseInt(Module.canvas.style.width); },  
 175180: () => { document.exitFullscreen(); },  
 175207: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 175279: () => { if (document.fullscreenElement) return 1; },  
 175325: () => { return Module.canvas.width; },  
 175357: () => { return screen.width; },  
 175382: () => { document.exitFullscreen(); },  
 175409: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 175603: () => { return window.innerWidth; },  
 175629: () => { return window.innerHeight; },  
 175656: () => { if (document.fullscreenElement) return 1; },  
 175702: () => { return Module.canvas.width; },  
 175734: () => { return parseInt(Module.canvas.style.width); },  
 175782: () => { if (document.fullscreenElement) return 1; },  
 175828: () => { return Module.canvas.width; },  
 175860: () => { return screen.width; },  
 175885: () => { return window.innerWidth; },  
 175911: () => { return window.innerHeight; },  
 175938: () => { if (document.fullscreenElement) return 1; },  
 175984: () => { return Module.canvas.width; },  
 176016: () => { return screen.width; },  
 176041: () => { document.exitFullscreen(); },  
 176068: () => { if (document.fullscreenElement) return 1; },  
 176114: () => { return Module.canvas.width; },  
 176146: () => { return parseInt(Module.canvas.style.width); },  
 176194: () => { document.exitFullscreen(); },  
 176221: ($0) => { Module.canvas.style.opacity = $0; },  
 176259: () => { return screen.width; },  
 176284: () => { return screen.height; },  
 176310: () => { return window.screenX; },  
 176337: () => { return window.screenY; },  
 176364: () => { return window.devicePixelRatio; },  
 176400: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 176453: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 176504: () => { Module.canvas.style.cursor = 'none'; },  
 176541: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 176797: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 176848: () => { if (document.pointerLockElement) return 1; },  
 176895: () => { if (document.fullscreenElement) return 1; },  
 176941: () => { return window.innerWidth; },  
 176967: () => { return window.innerHeight; }
};
